#MADE NEW FILE TO BE MESSED WITH
...
class Motor(object):
    ...
    def move_to(self, angle):
        ...
        if steps > self.steps_per_rev / 2:
            steps -= self.steps_per_rev #SHOULD MOVE DESIRED STEPS
            print "moving " + `steps` + " steps" #NEED TO TAKE OUT (DOESNT NEED TO PRINT)
            if self.mode == 2:
                self._move_acw_2(-steps / 8) #DO NOT UNDERSTAND WHAT THIS DOES?
            else:
